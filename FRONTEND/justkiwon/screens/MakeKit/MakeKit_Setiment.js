...
const STORAGE_KEY="@toDos_setiment"
...
export default function MakeKit_Setiment({ navigation, finalhi,setFinalhi, final_select, Setfinal_select,Navi,setNavi }) {
  const tent = {
    1: {
      name: "돔텐트",
    ...
    <SafeAreaView>
      ...
      <View style={{ justifyContent: 'flex-start', height: windowHeight }}>
        <View style={styles.header}>
          <ImageBackground source={require("../../assets/images/MakeKit/mood.png")} style={styles.header_image}>
