...
export default function MakeKit_Table({ navigation, finalhi,setFinalhi, final_select, Setfinal_select,Navi,setNavi }) {
  const tent = {
    1: {
      name: "돔텐트",
    ...
    <SafeAreaView>
      ...
      <View style={{ justifyContent: 'flex-start', height: windowHeight }}>
        <View style={styles.header}>
          <ImageBackground source={require("../../assets/images/MakeKit/table.png")} style={styles.header_image}>
