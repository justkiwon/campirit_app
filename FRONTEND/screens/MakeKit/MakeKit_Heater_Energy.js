...
const STORAGE_KEY="@toDos_Heater"
...
export default function MakeKit_Heater_Energy({ navigation, finalhi,setFinalhi, final_select, Setfinal_select,Navi,setNavi }) {
  const tent = {
    1: {
      name: "돔텐트",
...
//  ------------------------------------------------------------------------------------
 ...
 const NEXT = () => {
  for(var f=0;f<Navi.length;f++){
      if(Navi[f][1] == "MakeKit_Heater_Energy"){
          Navi[f][0]=true;
