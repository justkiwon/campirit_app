...
export default function MakeKit_Box({ navigation, finalhi,setFinalhi, final_select, Setfinal_select,Navi,setNavi }) {
  const tent = {
    1: {
      name: "돔텐트",
...
//  ------------------------------------------------------------------------------------
 ...
 const NEXT = () => {
  for(var f=0;f<Navi.length;f++){
      if(Navi[f][1] == "MakeKit_Box"){
          Navi[f][0]=true;
          navigation.navigate("Loadng2");
          break;
      }
  }
    ...
    <SafeAreaView>
      ...
      <View style={{ justifyContent: 'flex-start', height: windowHeight }}>
        <View style={styles.header}>
          <ImageBackground source={require("../../assets/images/MakeKit/box.png")} style={styles.header_image}>
