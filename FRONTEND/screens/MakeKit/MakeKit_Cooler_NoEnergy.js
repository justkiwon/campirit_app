...
const STORAGE_KEY="@toDos_Cooler123"
...
export default function MakeKit_Cooler_NoEnergy({ navigation, finalhi,setFinalhi, final_select, Setfinal_select,Navi,setNavi }) {
  const tent = {
    1: {
      name: "돔텐트",
...
//  ------------------------------------------------------------------------------------
 ...
 const NEXT = () => {
  for(var f=0;f<Navi.length;f++){
      if(Navi[f][1] == "MakeKit_Cooler_NoEnergy"){
          Navi[f][0]=true;
